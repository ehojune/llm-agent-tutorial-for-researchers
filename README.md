...
그날 대화창에서 입력창 왼쪽 아래 **권한 무시**를 한 번 눌러줘야 중간에 멈추지 않습니다.

<img width="560" alt="루틴 대화창 입력창 왼쪽 아래의 '권한 무시' 버튼" src="images/routine-permission-bypass.png" />
...
루틴을 시험 삼아 만들 때도 **매일 반복**으로 등록하세요. 일회성 루틴은 한 번 돌고 나면 스스로
꺼지면서 대화창까지 사라져서, 결과를 다시 찾을 수 없습니다.
